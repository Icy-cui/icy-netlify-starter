  ...
  return (
    <Layout title="Timeline">
      <div className="flex items-center justify-center align-middle">
        <div className="mx-6 mb-20 mt-6 grid grid-cols-2 gap-4">
          <div className="rounded-md bg-slate-100">
            <div className="mx-10 my-4 text-2xl font-extrabold underline italic">
              Hang's path:
            </div>
            <ul className="timeline timeline-vertical timeline-snap-icon p-4 max-md:timeline-compact">
              <li>
                ...
                <div className="timeline-start mb-10 md:text-end">
                  <time className="font-mono italic">China, Beijing</time>
              ...
              <li>
                ...
                <div className="timeline-end mb-10">
                  ...
                  use Apple's own iOS mobile operating system.
                </div>
                <hr />
              </li>
            </ul>
