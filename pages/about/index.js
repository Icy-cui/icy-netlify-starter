      ...
      <div className="flex min-h-full justify-center">
        <div className="py-auto mx-auto my-10 max-w-2xl bg-cover sm:px-2 sm:py-3">
          <div className="group relative">
            ...
            <div className="items-top relative flex justify-start space-x-6 rounded-lg bg-base-100 px-7 py-6 leading-none ring-1 ring-gray-900/5">
              <div className="space-y-1z">
                <h2 className="py-6 text-3xl font-bold underline decoration-indigo-500/30 underline-offset-4">
                  Who are we:
                </h2>
                <p className="pr-4 leading-7 text-base-content">
                  Welcome to our blog, We are Icy and Hang. <br></br>We enjoy
                  our life, making coffee, cooking, coding, and also proud to be
                  an amateur in photography after we get our new FUJI camera.
                </p>
                <h2 className="py-6 text-3xl font-bold underline decoration-sky-500/30 underline-offset-4">
                  Dev Gears Hardware:
                </h2>
                <div>
                  <ul className="list-inside list-disc pr-4 leading-7 text-base-content">
